...
int getf1(char **args,char ** serverinfo)
{
  ...
  if(args[2]!=NULL)
      ...
      if(strcmp(args[2],">")==0)
	{
	  if(args[3]==NULL)
	    {
	      fprintf(stderr, "Too less arguments. Argument should be of form \"getfl <filename> > <filename>\"\n");
	      return -1;
	    }
	    if(args[4]!=NULL)
	    {
	      fprintf(stderr, "Too many arguments. Argument should be of form \"getfl <filename> > <filename>\"\n");
	      return -1;
	    }
	  else
	    {
      ...
      else if(strcmp(args[2],"|")==0)
	{
	  if(args[3]==NULL)
	    {
	      fprintf(stderr, "Too less arguments. Argument should be of form \"getfl <filename> | <some-command>\"\n");
	      return -1;
	    }
	  else
	    {
